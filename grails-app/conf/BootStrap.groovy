...
//        }
        ...
        Menus menus13=new Menus(name:'htdj',title:'合同登记','hetong-dengji.jsp',parentId:menus1.id).save(failOnError: true)
        Menus menus14=new Menus(name:'htly',title:'合同领用','hetong-lingyong.jsp',parentId:menus1.id).save(failOnError: true)
        Menus menus15=new Menus(name:'htgh',title:'合同归还','hetong-guihuan.jsp',parentId:menus1.id).save(failOnError: true)

        Menus menus2=new Menus(name:'khgl',title:'客户管理',url:'').save(failOnError: true)
        Menus menus21=new Menus(name:'tjtzda',title:'添加投资档案','investment.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus22=new Menus(name:'dytzqrs',title:'打印投资确认书','investment-print.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus23=new Menus(name:'khxxxg',title:'客户信息修改','customer-list.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus24=new Menus(name:'ztdagl',title:'投资档案管理','invest-list.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus25=new Menus(name:'htcx',title:'合同查询','hetong-query.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus26=new Menus(name:'tccx',title:'提成查询','commission_query.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus27=new Menus(name:'tcsq',title:'提成申请','commission_apply.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus28=new Menus(name:'dfcx',title:'兑付查询','cash_app.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus29=new Menus(name:'dfsq',title:'兑付申请','cash_list.jsp',parentId:menus2.id).save(failOnError: true)
        Menus menus20=new Menus(name:'czjlrz',title:'操作记录日志','czjlrz-list.jsp',parentId:menus2.id).save(failOnError: true)

        Menus menus3=new Menus(name:'tssq',title:'特殊申请',url:'').save(failOnError: true)
        Menus menus31=new Menus(name:'hzxx',title:'汇总信息','specialSummary.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus32=new Menus(name:'tssqgl',title:'特殊申请管理','special-treat-list.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus33=new Menus(name:'wtfksq',title:'委托付款申请','special-paytreat.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus34=new Menus(name:'dqztsq',title:'到期转投申请','special_treat.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus35=new Menus(name:'wdqztsq',title:'未到期转投申请','special_treat.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus36=new Menus(name:'thsq',title:'退伙申请','refund_add.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus37=new Menus(name:'xtsq',title:'续投申请','continuedinvestment-add.jsp',parentId:menus3.id).save(failOnError: true)
        Menus menus38=new Menus(name:'hbsq',title:'合并申请','special-merge.jsp',parentId:menus3.id).save(failOnError: true)

        Menus menus4=new Menus(name:'xmgl',title:'项目管理',url:'').save(failOnError: true)
        Menus menus41=new Menus(name:'xjxm',title:'新建项目','new_project.jsp',parentId:menus4.id).save(failOnError: true)
        Menus menus42=new Menus(name:'xmlb',title:'项目列表','project_list.jsp',parentId:menus4.id).save(failOnError: true)
        Menus menus43=new Menus(name:'xzhkjl',title:'新增汇款记录','new_pay_record.jsp',parentId:menus4.id).save(failOnError: true)
        Menus menus44=new Menus(name:'xzskjl',title:'新增收款记录','new_receive_record.jsp',parentId:menus4.id).save(failOnError: true)
        Menus menus45=new Menus(name:'xmzkmxb',title:'项目转款明细表','pay_record_list.jsp',parentId:menus4.id).save(failOnError: true)
        Menus menus46=new Menus(name:'xmjs',title:'项目结算','end_project.jsp',parentId:menus4.id).save(failOnError: true)

        Menus menus5=new Menus(name:'dagl',title:'档案管理',url:'').save(failOnError: true)
        Menus menus51=new Menus(name:'jycx',title:'借阅/查询','filepackage-list.jsp',parentId:menus5.id).save(failOnError: true)
        Menus menus52=new Menus(name:'dark',title:'档案入库','filepackage-add.jsp',parentId:menus5.id).save(failOnError: true)

        Menus menus6=new Menus(name:'yhyw',title:'银行业务',url:'').save(failOnError: true)
        Menus menus61=new Menus(name:'fkdcx',title:'付款单查询','bankingpaymentorder.jsp',parentId:menus6.id).save(failOnError: true)
        Menus menus62=new Menus(name:'jzpzscsz',title:'记账凭证生成设置','forms.html',parentId:menus6.id).save(failOnError: true)
        Menus menus63=new Menus(name:'jzpzcx',title:'记账凭证查询','forms.html',parentId:menus6.id).save(failOnError: true)
        Menus menus64=new Menus(name:'yhxxcx',title:'银行信息查询','bankingTransportation.jsp',parentId:menus6.id).save(failOnError: true)
        Menus menus65=new Menus(name:'jyxxcx',title:'交易信息查询','bankingTransportation.jsp',parentId:menus6.id).save(failOnError: true)
        Menus menus66=new Menus(name:'tkcx',title:'退款查询','bankingTransportation.jsp',parentId:menus6.id).save(failOnError: true)
        Menus menus67=new Menus(name:'dzhdgl',title:'电子回单管理','bankingTransportation.jsp',parentId:menus6.id).save(failOnError: true)
        Menus menus68=new Menus(name:'yhywxtrz',title:'银行业务系统日志','bankingTransportation.jsp',parentId:menus6.id).save(failOnError: true)

        Menus menus7=new Menus(name:'xtsz',title:'系统设置',url:'').save(failOnError: true)
        Menus menus71=new Menus(name:'qxgl',title:'权限管理','authority-list.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus72=new Menus(name:'gsgl',title:'公司管理','company-list.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus73=new Menus(name:'xzgs',title:'新增公司','company-create.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus74=new Menus(name:'bmgl',title:'部门管理','department-list.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus75=new Menus(name:'xzbm',title:'新增部门','department-create.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus76=new Menus(name:'jsgl',title:'角色管理','role-list.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus77=new Menus(name:'xzjs',title:'新增角色','role-create.jsp',parentId:menus7.id).save(failOnError: true)
        Menus menus78=new Menus(name:'yhgl',title:'用户管理','user-list.jsp',parentId:menus7.id).save(failOnError: true)
