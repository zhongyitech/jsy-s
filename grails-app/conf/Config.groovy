...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.jsy.auth.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.jsy.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'com.jsy.auth.Role'
...
grails.plugin.springsecurity.rest.token.storage.gorm.tokenDomainClassName = 'com.jsy.auth.AuthenticationToken'
...
grails {
    plugin {
        springsecurity {
            ...
            active = true
            userLookup.userDomainClassName = "com.jsy.auth.User"
            authority.className = "com.jsy.auth.User"
